...
const bgSunnyImagePath = "/backgroundimages/bg-sunny.png";
const bgCloudyImagePath = "/backgroundimages/bg-cloudy.png";
const bgRainyImagePath = "/backgroundimages/bg-rainy.png";
const bgSnowImagePath = "/backgroundimages/bg-snow.png";
...
const iconCloudyImagePath = "/icons/weather-cloudy.svg";
const iconFogImagePath = "/icons/weather-fog.svg";
const iconPartlyCloudyImagePath = "/icons/weather-partly cloudy.svg";
const iconRainImagePath = "/icons/weather-rain.svg";
const iconSnowImagePath = "/icons/weather-snow.svg";
const iconSunnyImagePath = "/icons/weather-sunny.svg";
const iconThunderstormImagePath = "/icons/weather-thunderstorm.svg";
